...
XCVAR_DEF(ui_findPlayer, "DEFAULT_MODEL", NULL, CVAR_ARCHIVE | CVAR_INTERNAL)
...
XCVAR_DEF(ui_menuFilesMP, "ui/MovieDuels-MP-Menus.txt", NULL, CVAR_ARCHIVE | CVAR_INTERNAL)
...
XCVAR_DEF(ui_serverFilterType, "0", NULL, CVAR_ARCHIVE | CVAR_INTERNAL) //SERVER FILTER was 1
...
XCVAR_DEF(ui_rgb_saber_red, "255", NULL, CVAR_INTERNAL)
XCVAR_DEF(ui_rgb_saber_blue, "255", NULL, CVAR_INTERNAL)
XCVAR_DEF(ui_rgb_saber_green, "255", NULL, CVAR_INTERNAL)
XCVAR_DEF(ui_rgb_saber2_red, "255", NULL, CVAR_INTERNAL)
XCVAR_DEF(ui_rgb_saber2_blue, "255", NULL, CVAR_INTERNAL)
XCVAR_DEF(ui_rgb_saber2_green, "255", NULL, CVAR_INTERNAL)

XCVAR_DEF(cg_SFXSabers, "4", NULL, CVAR_ARCHIVE)
XCVAR_DEF(cg_SFXSabersGlowSize, "1.0", NULL, CVAR_ARCHIVE)
XCVAR_DEF(cg_SFXSabersCoreSize, "1.0", NULL, CVAR_ARCHIVE)
XCVAR_DEF(cg_SFXLerpOrigin, "0", NULL, CVAR_ARCHIVE)
...
XCVAR_DEF(cg_SFXSabersCoreSizeOT, "1.0", NULL, CVAR_ARCHIVE)
XCVAR_DEF(cg_SFXSabersGlowSizeROTJ, "1.0", NULL, CVAR_ARCHIVE)
XCVAR_DEF(cg_SFXSabersCoreSizeROTJ, "1.0", NULL, CVAR_ARCHIVE)
XCVAR_DEF(cg_SFXSabersGlowSizeTFA, "1.0", NULL, CVAR_ARCHIVE)
XCVAR_DEF(cg_SFXSabersCoreSizeTFA, "1.0", NULL, CVAR_ARCHIVE)
XCVAR_DEF(cg_SFXSabersGlowSizeUSB, "1.0", NULL, CVAR_ARCHIVE)
XCVAR_DEF(cg_SFXSabersCoreSizeUSB, "1.0", NULL, CVAR_ARCHIVE)
