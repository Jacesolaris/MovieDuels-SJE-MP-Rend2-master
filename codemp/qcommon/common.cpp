...
{
	Cbuf_ExecuteText(EXEC_NOW, "exec MovieDuels-MP-default.cfg\n");
...
void Com_WriteConfig_f(void)
{
	...
	if (!FS_FilenameCompare(filename, "MovieDuels-MP-default.cfg") || !FS_FilenameCompare(filename, "MovieDuels-SP-default.cfg"))
	{
