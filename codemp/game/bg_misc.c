...
int WeaponIdleAnim[WP_NUM_WEAPONS] =
{
	...
	BOTH_STAND3,//WP_BATTLEDROID,
	BOTH_STAND3,//WP_THEFIRSTORDER,
	BOTH_STAND3,//WP_CLONECARBINE,
	TORSO_WEAPONIDLE2,//WP_REBELBLASTER,
	BOTH_STAND3,//WP_CLONERIFLE,
	BOTH_STAND3,//WP_CLONECOMMANDO,
	BOTH_STAND3,//WP_Z6_ROTARY_CANNON,
	BOTH_STAND3,//WP_REBELRIFLE,
	TORSO_WEAPONIDLE2,//WP_REY,
	TORSO_WEAPONIDLE2,//WP_JANGO,
	BOTH_STAND3,//WP_BOBA,
	TORSO_WEAPONIDLE2,//WP_CLONEPISTOL,
...
int WeaponAimAnim[WP_NUM_WEAPONS] = // Single weapon Aiming
{
	TORSO_DROPWEAP1, //WP_NONE,
...
int WeaponAimAnim2[WP_NUM_WEAPONS] = // dual weapon Aiming
{
	TORSO_DROPWEAP1, //WP_NONE,
...
int WeaponAltAimAnim[WP_NUM_WEAPONS] = // Single weapon Alt Aiming
{
	TORSO_DROPWEAP1, //WP_NONE,
...
int WeaponAltAimAnim2[WP_NUM_WEAPONS] = // dual weapon Alt Aiming
{
	TORSO_DROPWEAP1, //WP_NONE,
