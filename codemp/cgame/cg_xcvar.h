...
XCVAR_DEF(cg_adaptiveCrosshair, "0", NULL, CVAR_ARCHIVE)
...
XCVAR_DEF(cg_hudFiles, "ui/MovieDuels-MP-Hud.txt", NULL, CVAR_ARCHIVE)
...
XCVAR_DEF(MovieDuels_Clientplugin, CURRENT_MD_CLIENTVERSION, NULL, CVAR_USERINFO | CVAR_ROM)
